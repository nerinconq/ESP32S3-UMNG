...
1. En tu celular o PC, buscar la red WiFi **"PhysysLab_XXXX"**
2. Conectarse (la contraseña estará en los logs o en `config.json`)
3. Abrir el navegador e ir a: **http://192.168.4.1**
4. Verificar que la interfaz web carga correctamente
